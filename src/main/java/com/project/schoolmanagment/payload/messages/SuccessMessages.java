...
public abstract class SuccessMessages {
	...
	//Admin
	public static final String ADMIN_CREATE = "Admin is created successfully";
	...
	public static final String VICE_DEAN_FOUND = "ViceDean is Found Successfully";
	public static final String VICE_DEAN_DELETE = "ViceDean is Deleted Successfully";
